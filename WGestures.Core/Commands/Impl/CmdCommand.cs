...
namespace WGestures.Core.Commands.Impl
{
    ...
    public class CmdCommand : AbstractCommand, IGestureContextAware
    {
        ...
        public CmdCommand()
        {
            ...
            this.AutoSetWorkingDir = true;
        }

        [JsonProperty] public string Code { get; set; }

        [JsonProperty] public bool ShowWindow { get; set; }

        [JsonProperty] public bool AutoSetWorkingDir { get; set; }

        private string NormalizedCode
        {
            get
            {
                var sb = new StringBuilder(this.Code.Length);
        ...
        public override void Execute()
        {
            using (var process = new Process())
            {
                ...
                process.StartInfo.Arguments =
                    (this.ShowWindow ? "/k " : "/C ") + this.NormalizedCode;
                ...
                if (this.Context != null)
                {
                    process.StartInfo.EnvironmentVariables.Add(
                        "WG_PROCID",
                        this.Context.ProcId.ToString());
                    process.StartInfo.EnvironmentVariables.Add(
                        "WG_WINID",
                        this.Context.WinId.ToString());
                    process.StartInfo.EnvironmentVariables.Add(
                        "WG_STARTPOINT_X",
                        this.Context.StartPoint.X.ToString());
                    process.StartInfo.EnvironmentVariables.Add(
                        "WG_STARTPOINT_Y",
                        this.Context.StartPoint.Y.ToString());
                    process.StartInfo.EnvironmentVariables.Add(
                        "WG_ENDPOINT_X",
                        this.Context.EndPoint.X.ToString());
                    process.StartInfo.EnvironmentVariables.Add(
                        "WG_ENDPOINT_Y",
                        this.Context.EndPoint.X.ToString());
                }
                ...
                process.StartInfo.WindowStyle = this.ShowWindow
