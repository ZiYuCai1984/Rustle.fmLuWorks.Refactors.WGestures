...
{
    /// <summary>
    ///     The contract for a service that dispatches <see cref="INPUT" /> messages to the appropriate
    ///     destination.
    /// </summary>
    internal interface IInputMessageDispatcher
    {
        ...
        ///     If the any of the commands in the <paramref name="inputs" /> array
        ///     could not be sent successfully.
        /// </exception>
        void DispatchInput(INPUT[] inputs);

        unsafe void DispatchInput(INPUT* inputs, uint count);
    }
}
