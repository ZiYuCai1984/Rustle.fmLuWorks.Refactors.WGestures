...
{
    /// <summary>
    ///     Implements the <see cref="IMouseSimulator" /> interface by calling the an
    ///     <see cref="IInputMessageDispatcher" /> to simulate Mouse gestures.
    /// </summary>
    public class MouseSimulator : IMouseSimulator
    {
        ...
        /// <summary>
        ///     The instance of the <see cref="IInputMessageDispatcher" /> to use for dispatching
        ...
        ///     The <see cref="IInputMessageDispatcher" /> to use for dispatching
        ///     <see cref="INPUT" /> messages.
        /// </param>
        /// <exception cref="InvalidOperationException">
        ///     If null is passed as the
        ///     <paramref name="messageDispatcher" />.
        /// </exception>
        internal MouseSimulator(
            IInputSimulator inputSimulator, IInputMessageDispatcher messageDispatcher)
        {
            if (inputSimulator == null)
            {
                throw new ArgumentNullException("inputSimulator");
        ...
        /// <summary>
        ///     Simulates mouse movement by the specified distance measured as a delta from the current mouse
        ///     location in pixels.
        /// </summary>
        ...
        ///     The destination's absolute X-coordinate on the primary display device where
        ///     0 is the extreme left hand side of the display device and 65535 is the extreme right hand side
        ///     of the display device.
        /// </param>
        /// <param name="absoluteY">
        ///     The destination's absolute Y-coordinate on the primary display device where
        ///     0 is the top of the display device and 65535 is the bottom of the display device.
        /// </param>
        public IMouseSimulator MoveMouseTo(double absoluteX, double absoluteY)
        {
            var inputList = new InputBuilder
                    {ExtraInfo = _inputSimulator.ExtraInfo}.AddAbsoluteMouseMovement(
        ...
        /// <summary>
        ///     Simulates mouse movement to the specified location on the Virtual Desktop which includes all
        ///     active displays.
        /// </summary>
        /// <param name="absoluteX">
        ///     The destination's absolute X-coordinate on the virtual desktop where 0 is
        ///     the left hand side of the virtual desktop and 65535 is the extreme right hand side of the
        ///     virtual desktop.
        /// </param>
        /// <param name="absoluteY">
        ///     The destination's absolute Y-coordinate on the virtual desktop where 0 is
        ///     the top of the virtual desktop and 65535 is the bottom of the virtual desktop.
        /// </param>
        ...
        {
            var inputList = new InputBuilder
                    {ExtraInfo = _inputSimulator.ExtraInfo}.AddMouseButtonUp(MouseButton.LeftButton)
                .ToArray();
            this.SendSimulatedInput(inputList);
            return this;
        }
        ...
        {
            var inputList = new InputBuilder
                    {ExtraInfo = _inputSimulator.ExtraInfo}.AddMouseXButtonDown(buttonId)
                .ToArray();
            this.SendSimulatedInput(inputList);
            return this;
        }
        ...
        {
            var inputList = new InputBuilder
                    {ExtraInfo = _inputSimulator.ExtraInfo}.AddMouseXButtonUp(buttonId)
                .ToArray();
            this.SendSimulatedInput(inputList);
            return this;
        }
        ...
        {
            var inputList = new InputBuilder
                    {ExtraInfo = _inputSimulator.ExtraInfo}.AddMouseXButtonClick(buttonId)
                .ToArray();
            this.SendSimulatedInput(inputList);
            return this;
        }
        ...
        {
            var inputList = new InputBuilder
                    {ExtraInfo = _inputSimulator.ExtraInfo}.AddMouseXButtonDoubleClick(buttonId)
                .ToArray();
            this.SendSimulatedInput(inputList);
            return this;
        }
        ...
        ///     The amount to scroll in clicks. A positive value indicates that
        ///     the wheel was rotated forward, away from the user; a negative value indicates that the wheel
        ...
        /// <param name="scrollAmountInClicks">
        ///     The amount to scroll in clicks. A positive value indicates that
        ///     the wheel was rotated to the right; a negative value indicates that the wheel was rotated to
        ///     the left.
        /// </param>
        ...
        /// <summary>
        ///     Sends the list of <see cref="INPUT" /> messages using the
        ///     <see cref="IInputMessageDispatcher" /> instance.
        /// </summary>
