...
namespace WindowsInput
{
    ...
    public class WindowsInputDeviceStateAdapter : IInputDeviceStateAdapter
    {
        ...
        ///     values for Bthe nVirtKey parameter. This gives the status of the SHIFT, CTRL, or ALT keys
        ...
        /// <summary>
        ///     Determines whether the specified key is up or downby calling the
        ...
        /// <summary>
        ///     Determines whether the physical key is up or down at the time the function is called regardless
        ///     of whether the application thread has read the keyboard event from the message pump by calling
        ///     the <see cref="NativeMethods.GetAsyncKeyState" /> function. (See:
