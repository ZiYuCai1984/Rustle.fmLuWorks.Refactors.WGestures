...
{
    /// <summary>
    ///     A helper class for building a list of <see cref="INPUT" /> messages ready to be sent to the
    ///     native Windows API.
    /// </summary>
    internal class InputBuilder : IEnumerable<INPUT>
    {
        ...
        ///     the list of <see cref="INPUT" /> messages.
        /// </returns>
        ...
        /// <summary>
        ///     Returns the list of <see cref="INPUT" /> messages as a <see cref="System.Array" /> of
        ...
        /// <remarks>
        ///     The extended keys consist of the ALT and CTRL keys on the right-hand side of the keyboard; the
        ///     INS, DEL, HOME, END, PAGE UP, PAGE DOWN, and arrow keys in the clusters to the left of the
        ///     numeric keypad; the NUM LOCK key; the BREAK (CTRL+PAUSE) key; the PRINT SCRN key; and the
        ...
        {
            var VirtualScanCode = NativeMethods.MapVirtualKey(
                (uint) keyCode,
                (uint) NativeMethods.MAPVK.MAPVK_VK_TO_VSC);
                    ...
                    Data =
                    {
                        Keyboard =
                            new KEYBDINPUT
                            {
                                ...
                                Flags =
                                    IsExtendedKey(keyCode) ? (uint) KeyboardFlag.ExtendedKey : 0,
                                Time = 0,
        ...
        /// <summary>
        ///     Adds a key press to the list of <see cref="INPUT" /> messages which is equivalent to a key down
        ...
        ///     The <see cref="System.Char" /> to be added to the list of
        ///     <see cref="INPUT" /> messages.
        /// </param>
        /// <returns>This <see cref="InputBuilder" /> instance.</returns>
        ...
        /// <summary>
        ///     Adds all of the characters in the specified <see cref="IEnumerable{T}" /> of
        ///     <see cref="char" />.
        /// </summary>
        ...
        public InputBuilder AddRelativeMouseMovement(int x, int y)
        {
            ...
            movement.Data.Mouse.ExtraInfo = this.ExtraInfo;
        ...
        {
            var movement = new INPUT {Type = (uint) InputType.Mouse};
            movement.Data.Mouse.Flags =
                (uint) (MouseFlag.Move | MouseFlag.Absolute | MouseFlag.VirtualDesk);
            movement.Data.Mouse.ExtraInfo = this.ExtraInfo;
            movement.Data.Mouse.X = absoluteX;
            movement.Data.Mouse.Y = absoluteY;
        ...
        public InputBuilder AddMouseButtonDown(MouseButton button)
        {
            ...
            buttonDown.Data.Mouse.ExtraInfo = this.ExtraInfo;
        ...
        public InputBuilder AddMouseButtonUp(MouseButton button)
        {
            ...
            buttonUp.Data.Mouse.ExtraInfo = this.ExtraInfo;
        ...
        public InputBuilder AddMouseVerticalWheelScroll(int scrollAmount)
        {
            ...
            scroll.Data.Mouse.ExtraInfo = this.ExtraInfo;
