...
{
    /// <summary>
    ///     Implements compressed binary serialization: designed to fit serialized data into the smallest
    ///     space possible.
    ///     This class extends the SerializationBinder and overrides the BindToName method to prevent
    ///     assembly or type information being written into the
    ///     serialization stream.
    ///     This means that the serializer must know the type of the object in order to de-serialize it,
    ///     hence the use of generics in the
    ...
    public class TinySerializer : SerializationBinder
    {
        ...
        /// <summary>
        ///     construct with the type to be de-serialized. private to prevent construction from outside this
        ///     class.
        /// </summary>
...
//        }
        ...
        /// <summary>
        ///     instead of binding to the specified type (which will be null when de-serializing an object
        ///     serialized using this binder)
        ...
        /// <summary>
        ///     deserialize the contents of the stream to the specified type. be sure that the stream contains
        ///     the type specified.
        /// </summary>
        ...
        /// <summary>
        ///     serialize the object to the destination stream and use Gzip compression to reduce it's size on
        ///     the way.
        /// </summary>
        /// <param name="destinationStream">the destination stream</param>
        /// <param name="graph">the object to serialize.</param>
        public static void SerializeCompressed(
            Stream destinationStream, object graph, bool stripTypeNames = false)
        {
        ...
        /// <returns></returns>
        public static T DeSerializeCompressed<T>(
            Stream compressedInputStream, bool useCustomBinder = false)
        {
            ...
            using var decompressionStream = new DeflateStream(
                compressedInputStream,
                CompressionMode.Decompress,
                true);
            // deserialize to an object:
            var graph = formatter.Deserialize(decompressionStream);
        ...
        public static byte[] Deflate(byte[] data)
        {
            ...
            using var df = new DeflateStream(outputStream, CompressionMode.Compress, true);
