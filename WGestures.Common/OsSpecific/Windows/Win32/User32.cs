...
//
        ...
        public static extern bool SystemParametersInfo(
            uint uiAction, uint uiParam, ref uint pvParam, SPIF fWinIni); // T = any type

        [DllImport("user32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SystemParametersInfo(
            uint uiAction, uint uiParam, IntPtr pvParam, SPIF fWinIni);

        // For setting a string parameter
        [DllImport("user32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SystemParametersInfo(
            uint uiAction, uint uiParam, string pvParam, SPIF fWinIni);

        // For reading a string parameter
        [DllImport("user32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SystemParametersInfo(
            uint uiAction, uint uiParam, StringBuilder pvParam, SPIF fWinIni);
...
//
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SystemParametersInfo(
            uint uiAction, uint uiParam, ref ANIMATIONINFO pvParam, SPIF fWinIni);
...
//
        ...
        public struct WNDCLASSEX
        {
            ...
            [MarshalAs(UnmanagedType.U4)] public CS style;
...
//
        ...
        [DllImport(User32Dll)]
        public static extern void SetWindowLong(IntPtr hwnd, GWL nIndex, int dwNewLong);

        [DllImport(User32Dll)]
        public static extern IntPtr SetWindowLong(IntPtr hwnd, GWL nIndex, IntPtr dwNewLong);
...
//
        ...
        public enum WS_EX : uint
        {
            ...
            ///     double-buffering. For more information, see Remarks. This cannot be used if the window has a
            ///     class style of either CS_OWNDC or CS_CLASSDC.
            /// </summary>
            WS_EX_COMPOSITED = 0x02000000,

            /// <summary>
            ///     Includes a question mark in the title bar of the window. When the user clicks the question
            ///     mark, the cursor changes to a question mark with a pointer. If the user then clicks a child
            ///     window, the child receives a WM_HELP message. The child window should pass the message to the
            ///     parent window procedure, which should call the WinHelp function using the HELP_WM_HELP command.
            ///     The Help application displays a pop-up window that typically contains help for the child
            ///     window.
            ...
            ///     window when the user clicks it. The system does not bring this window to the foreground when
            ///     the user minimizes or closes the foreground window.
            ...
            /// <summary>
            ///     Windows 2000/XP: A window created with this style does not pass its window layout to its child
            ///     windows.
            /// </summary>
            WS_EX_NOINHERITLAYOUT = 0x00100000,

            /// <summary>
            ///     Specifies that a child window created with this style does not send the WM_PARENTNOTIFY message
            ...
            /// <summary>
            ///     Creates a window with a three-dimensional border style intended to be used for items that do
            ...
            /// <summary>
            ///     Specifies that a window created with this style should be placed above all non-topmost windows
...
//
        ...
        public static extern bool SetWindowPos(
            IntPtr hWnd, IntPtr hWndInsertAfter, int X, int Y, int cx, int cy, SWP uFlags);
...
//
        ...
        public static extern void mouse_event(
            MOUSEEVENTF dwFlags, int dx, int dy, uint dwData, int dwExtraInfo);

        [DllImport(User32Dll, SetLastError = true)]
        public static extern void keybd_event(
            byte bVk, byte bScan, KEYEVENTF dwFlags, uint dwExtraInfo);
...
//        public static extern bool GetCursorPos(out Point lpPoint);
        ...
        public struct CURSORINFO
        {
            ...
            public POINT
                ptScreenPos; // A POINT structure that receives the screen coordinates of the cursor.
        }
...
//
        ...
        public static extern bool EnumDisplayMonitors(
            HandleRef hdc, COMRECT rcClip, MonitorEnumProc lpfnEnum, IntPtr dwData);
        ...
        [DllImport(User32Dll, CharSet = CharSet.Auto)]
        public static extern bool SystemParametersInfo(
            int nAction, int nParam, ref GDI32.RECT rc, int nUpdate);
...
//        /// </remark>
        ...
        public struct ANIMATIONINFO
        {
            ...
            ///     If non-zero and SPI_SETANIMATION is specified, enables minimize/restore
            ///     animation.
            /// </param>
