...
namespace WGestures.App.Gui.Windows
{
    public partial class QuickStartGuideForm : Form
    {
        public QuickStartGuideForm()
        {
            ...
            this.ClientSize = new Size(936 * dpiScale, 525 * dpiScale);
        ...
        {
            web_container.Navigate(
                new Uri(
                    string.Format(
                        @"{0}\QuickStartGuide\index.html",
        ...
        {
            if (web_container.Document == null)
            {
                return;
            }
            ...
            if (e.KeyData == (Keys.Alt | Keys.Right) || e.KeyData == (Keys.Control | Keys.Tab))
            {
                web_container.Document.InvokeScript("performNext");
                     ...
                     || e.KeyData == (Keys.Control | Keys.Tab | Keys.Shift))
            {
        ...
        {
            web_container.PreviewKeyDown -= this.web_container_PreviewKeyDown;
