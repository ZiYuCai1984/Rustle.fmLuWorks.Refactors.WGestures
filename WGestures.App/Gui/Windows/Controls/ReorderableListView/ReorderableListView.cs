...
namespace WGestures.App.Gui.Windows.Controls
{
    public class ReorderableListView : ListView
    {
        ...
        /// </summary>
        /// <param name="drgevent">
        ///     A <see cref="T:System.Windows.Forms.DragEventArgs" /> that contains the
        ///     event data.
        /// </param>
                ...
                try
                {
                    ...
                    if (dropItem != null)
                    {
                        ...
                        if (this.InsertionMode == InsertionMode.After
                            && dragItem.Index < this.Items.Count - 1)
                        {
                            dropIndex++;
                        }
                        ...
                        if (dropIndex != dragItem.Index)
                        {
                            ...
                            args = new ListViewItemDragEventArgs(
                                dragItem,
                                dropItem,
                                dropIndex,
                                this.InsertionMode,
        ...
        protected override void OnDragOver(DragEventArgs drgevent)
        {
            if (this.IsRowDragInProgress)
            {
                ...
                clientPoint = this.PointToClient(new Point(drgevent.X, drgevent.Y));
                dropItem = this.GetItemAt(
                    0,
                    Math.Min(
                        clientPoint.Y,
                        this.Items[this.Items.Count - 1].GetBounds(ItemBoundsPortion.Entire).Bottom
                        - 1));
                ...
                if (dropItem != null)
                {
                    ...
                    insertionMode = clientPoint.Y < bounds.Top + bounds.Height / 2
                    ...
                    {
                        this.EnsureVisible(dropItem.Index);
                        _interval = now;
                    }
                }
                else
        ...
        /// </summary>
        /// <param name="e">
        ///     An <see cref="T:System.Windows.Forms.ItemDragEventArgs" /> that contains the event
        ///     data.
        /// </param>
        ...
        /// </summary>
        /// <param name="e">
        ///     A <see cref="T:System.Windows.Forms.PaintEventArgs" /> that contains the event
        ///     data.
        /// </param>
        ...
        {
            get => this.SelectedItems.Count != 0 ? this.SelectedItems[0] : null;
            set
            {
        ...
        /// </summary>
        /// <param name="e">
        ///     The <see cref="CancelListViewItemDragEventArgs" /> instance containing the event
        ///     data.
        /// </param>
            ...
            if (this.InsertionIndex != -1)
            {
                ...
                if (index >= 0 && index < this.Items.Count)
                {
                    ...
                    width = Math.Min(
                        ...
                        this.ClientSize
                            .Width); // again, make sure the full width fits in the client area
        ...
        private void DrawInsertionLine(int x1, int y, int width)
        {
            using (var g = this.CreateGraphics())
            {
                ...
                leftArrowHead = new[]
                {
                    new Point(x1, y - arrowHeadSize / 2), new Point(x1 + arrowHeadSize, y),
                    new Point(x1, y + arrowHeadSize / 2)
                };
                rightArrowHead = new[]
                {
                    new Point(x2, y - arrowHeadSize / 2), new Point(x2 - arrowHeadSize, y),
                    new Point(x2, y + arrowHeadSize / 2)
                };

                using (var pen = new Pen(this.InsertionLineColor))
                {
