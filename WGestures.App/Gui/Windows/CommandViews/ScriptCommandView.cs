...
namespace WGestures.App.Gui.Windows.CommandViews
{
    public partial class ScriptCommandView : CommandViewUserControl
    {
        ...
        private void txt_script_TextChanged(object sender, EventArgs e)
        {
            _cmd.Script = txt_script.Text;
        }

        private void txt_initScript_TextChanged(object sender, EventArgs e)
        {
            _cmd.InitScript = txt_initScript.Text;
        }

        private void check_handleModifiers_CheckedChanged(object sender, EventArgs e)
        {
            _cmd.HandleModifiers = check_handleModifiers.Checked;
        }

        private void txt_modifierRecognized_TextChanged(object sender, EventArgs e)
        {
            _cmd.GestureRecognizedScript = txt_modifierRecognized.Text;
        }

        private void txt_modifierTriggered_TextChanged(object sender, EventArgs e)
        {
            _cmd.ModifierTriggeredScript = txt_modifierTriggered.Text;
        }

        private void txt_gestureEnded_TextChanged(object sender, EventArgs e)
        {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            var start = new ProcessStartInfo(
                "explorer",
                "https://github.com/yingDev/WGestures/wiki/Lua-%E8%84%9A%E6%9C%AC%E6%95%99%E7%A8%8B");
            Process.Start(start);
        }
